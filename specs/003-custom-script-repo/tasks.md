...
- [ ] T018 [US2] Add CSS for `.app-custom-notice` and `.custom-override-warning` in `web-client/src/index.css`, using existing theme variables so `:root[data-theme='dark']` works, and wrapping cleanly at ≤640px
