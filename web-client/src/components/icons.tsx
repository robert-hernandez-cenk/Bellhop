...
export function IconStart({ size = 16 }: IconProps) {
  return (
...
export function IconShutdown({ size = 16 }: IconProps) {
  return (
    <svg {...base} width={size} height={size}>
      <path d="M12 2v8" />
...
export function IconUpdate({ size = 16 }: IconProps) {
  return (
    <svg {...base} width={size} height={size}>
...
export function IconPackage({ size = 16 }: IconProps) {
  return (
    <svg {...base} width={size} height={size}>
